...
tape( 'the function throws an error if provided a tenth argument which is not a supported dtype', opts, function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided an eleventh argument which is not an array-like object', opts, function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided a twelfth argument which is not an integer', opts, function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided a thirteenth argument which is not a nonnegative integer', opts, function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided an eleventh argument which has insufficient elements', opts, function test( t ) {
	var values;
	var i;
...
tape( 'the function adds strided array elements', opts, function test( t ) {
	var expected;
	var len;
	var t1;
	var t2;
...
tape( 'the function supports a `z` offset', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var z;
