...
var EXCLUDE = [
	...
	'complex64', // FIXME: remove once JS support
	'complex128' // FIXME: remove once JS support
];
...
var FCN_BASENAME = 'add';
var FCN_DESCRIPTION = 'Adds two numbers.';
...
function main() {
	...
	for ( i = 0; i < fcns.length; i++ ) {
		...
		if ( t1 === FLOAT64_CHAR ) {
			...
			f = 'stdlib_base_'+t1+FCN_BASENAME;
